...
\cnum{56} Joseph Ditton$^*$ and John Edwards. Relative Self-Efficacy in Computer Science Courses. \textit{In ACM Technical Symposium on Computing Science Education (SIGCSE).} 2026. Qualis: A2.

\cnum{55} Matthew Burns$^*$, Wesley Edwards$^*$, and John Edwards. Describing Functionality in Natural Language May Improve Decomposition Behaviors. \textit{In ACM Technical Symposium on Computing Science Education (SIGCSE).} 2026. Qualis: A2.

\cnum{54} Matthew Rau$^*$ and John Edwards. What Do Students Pay Attention to While Watching Others Code? \textit{In The 28th Australasian Computing Education Conference (ACE).} 2026. Qualis: B2.
