...
%\end{itemize}
\textit{Revolutionary Data Presentation and Manipulation}. PI: M. Shields. co-PIs: \underline{J. Edwards}, D. Heath. Missile Defense Agency (STTI). B18C-001-0097. \$100,000. 2018. Pending.
...
\begin{itemize}[label={},leftmargin=0pt]
  \setlength\itemsep{0em}
  \item Bo Johnson (current)
  \item John Motley (Idaho State University)
  \item Galen Cochrane (Idaho State University)
  \item William Grigg (Idaho State University)
  \item Joseph Valentin (Idaho State University)
  \item Sandro Pawlidis (Idaho State University)
